...
class MoisimgscraperSpiderMiddleware:
...
class MoisimgscraperDeltaFetchSpiderMiddleware(scrapy_deltafetch.DeltaFetch) :
    threshold = 0
...
class MoisimgscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
