...
class MoisnewsscraperDeltaFetchSpiderMiddleware(scrapy_deltafetch.DeltaFetch):
...
class MoisnewsscraperSpiderMiddleware:
...
class MoisnewsscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
